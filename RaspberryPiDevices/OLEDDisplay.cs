...
public sealed class OLEDDisplay : IDisposable
{
    ...
    private readonly EventWaitHandle autoResetEventHandle;
    ...
    public OLEDDisplay(in int numberOfPages, in int widthPixel, in int heightPixel, in int fontSize = 12, in string fontFamilyName = "Cascadia Code")
        : this(numberOfPages, widthPixel, heightPixel, new TimeSpan(0, 0, 1), fontSize, fontFamilyName)
    {
    }

    /*[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]*/
    public OLEDDisplay(in int numberOfPages, in int widthPixel, in int heightPixel, in TimeSpan pageChangingInterval, in int fontSize = 12, in string fontFamilyName = "Cascadia Code")
    {
        Width = widthPixel;
        Height = heightPixel;
    ...
    {
        return Pages.TryAdd(pageIndex, text);
    }
    ...
    /*[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]*/
    public static OLEDDisplay Create_2_42in_OLED_Ssd1351(int numberOfPages, int fontSize = 12, string fontFamilyName = "Cascadia Code")
    {
        return new OLEDDisplay(numberOfPages, 128, 128, fontSize, fontFamilyName);
    }
